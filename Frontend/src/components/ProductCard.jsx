...
//         <p className="mt-1 font-bold text-[#6D2932]">₹ {product.price}
...
//     useEffect(() => {
//     setWishlisted(isWishlisted); // sync prop changes
//   }, [isWishlisted]);
...
//       setWishlisted(!wishlisted);
//        onWishlistChange(); // refresh wishlist in parent
//     } catch (err) {
//       console.error("Wishlist error:", err);
//     }
//   };
...
//   return (
//     <div
//       className="border rounded-lg overflow-hidden shadow hover:shadow-lg transition-all duration-300 bg-white cursor-pointer flex flex-col"
...
//         <h4 className="text-lg font-semibold text-[#6D2932] truncate">
//           {product.title}
//         </h4>
